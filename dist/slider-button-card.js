 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,s){const r=e[0];if("."===r){return new ct(t,e.slice(1),i).parts}if("@"===r)return[new dt(t,e.slice(1),s.eventContext)];if("?"===r)return[new at(t,e.slice(1),i)];return new rt(t,e,i).parts}handleTextExpression(t){return new nt(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
